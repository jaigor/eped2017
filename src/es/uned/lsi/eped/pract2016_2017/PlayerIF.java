...
public interface PlayerIF {
     ...
     * existentes
     * @return    -una lista con los identificadores de todas las listas de
     *            reproducción (no importa el orden) */
    public ListIF<String> getPlayListIDs();

    /**
     * Devuelve el contenido de una lista de reproducción
     * @param playListID -una cadena de caracteres no vacía con el identificador de la
    ...
    *         se introdujeron las canciones) */
     ...
     * @param lT         -una lista de identificadores de canciones contenidas en el
     *                    repositorio
     ...
     * @param al         -una cadena de caracteres con el álbum al que pertenece la
     *                    canción buscada
     * @param min_y      -un entero con el primer año del intervalo en el que se
     *                    publicó la canción a buscar
     * @param max_y      -un entero con el último año del intervalo en el que se
     *                    publicó la canción a buscar
     ...
     * @pos              -si existe una lista de reproducción con el identificador, se
     ...
     * @param tuneID     -un entero con el identificador de la canción del repositorio
     ...
     * @param al    -una cadena de caracteres con el álbum al que pertenece la
     *               canción buscada
     * @param min_y -un entero con el primer año del intervalo en el que se creó
     *               la canción a buscar
     * @param max_y -un entero con el último año del intervalo en el que se creó
     *               la canción a buscar
     * @param min_d -un entero con la duración mínima de la canción a buscar
     * @param max_d -un entero con la duración máxima de la canción a buscar
     ...
     * @pos     -si la cola de reproducción no esta vacía, se elimina de ella el
